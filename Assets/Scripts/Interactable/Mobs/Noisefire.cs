...
public class Noisefire : Interactble, IMob
{
    ...
    public override void MakeInteraction(PlayerController player)
    {
        ...
        int randomX = Random.Range(-MazeSpawner.Instance.width / 2, MazeSpawner.Instance.width / 2);
        int randomY = Random.Range(-MazeSpawner.Instance.height / 2, MazeSpawner.Instance.height / 2);
        player.transform.position = player.transform.position.With(x:randomX, y: randomY);
